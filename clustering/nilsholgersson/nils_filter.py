...
coords = {
    'Trelleborg': (55.36670, 13.15746),
    'Rostock': (54.15166, 12.10196),
    'Travemunde': (53.94, 10.8626),
    'Swinoujscie': (53.89612, 14.25595)
}
...
# Load data
data = pd.read_csv('datasets/nilsholgersson/nilsholgersson.csv')
...
# Save trips into csv
trip_df.to_csv('nils_trips.csv', index=False)

# Display the counts for each route
print(route_counts) """

# Load the trip metadata
trips_df = pd.read_csv('nils_trips.csv')
